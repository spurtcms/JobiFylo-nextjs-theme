                        ...
                        <div className="flex flex-col gap-8">
                            ...
                            <div className="flex gap-6 flex-col">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <input type="text" className="bg-white text-sm text-black font-light placeholder:text-slate-300 p-3 border border-gray-200 rounded-md focus-visible:outline-0" placeholder="Enter Emailid" />
                                </div>
                                <div className="flex flex-col gap-2">
                                    <label className="text-black text-sm font-medium">Mobile Number</label>
                                    <input type="text" className="bg-white text-sm text-black font-light placeholder:text-slate-300 p-3 border border-gray-200 rounded-md focus-visible:outline-0" placeholder="Enter Mobile number" />
                                </div>
                                <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-col gap-4">
                                <Link href="/" className="w-full h-11 rounded-md hover:bg-blue-600 bg-blue-700 text-white text-sm font-normal flex justify-center items-center">Register Now</Link>
                                <p className="text-base text-black font-light text-center">Have an account? <Link href="/signin" className="text-blue-600 font-medium"> Login Here</Link></p>
                            </div>
                        </div>
                    </div>
                </div>
