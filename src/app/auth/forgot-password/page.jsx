  ...
  const handleVerifyMailId = () => {
    ...
    if (validateMailId()) {
      const ForgotPasswordData = async () => {
        ...
        try {
          const forgotPass_Call = await fetchGraphQl(
            GET_HEADER_FORGOT_PASSWORD_QUERY,
            password_params
          );
        ...
        <div className="w-[90%] mx-auto max-[1400px]:w-full mb-auto">
          <div className="max-w-[394px] mx-auto mb-[24px]">
            ...
            <p className="text-base font-medium leading-[17px] text-[#83838D] text-center mb-[40px] max-[1300px]:mb-[16px]">
              No worries, we will send reset instruction
            </p>
            <div className="bg-[#FFFFFF] border border-[#E9E9E9] p-[30px] rounded-[12px] max-w-[394px] mx-auto">
              <div className="mb-[24px] last-of-type:mb-0">
                ...
                {successMsgShow && (
                  <div className="absolute flex items-start space-x-[4px] mt-[5px]">
                    {" "}
                    <p className="text-[10px] font-normal leading-[12px] text-[green]">
                      {sucesMsg}{" "}
                    </p>
                  </div>
                )}
              ...
              <button
                ...
                onClick={(e) => handleVerifyMailId(e)}
              >
                Verify
              </button>
            </div>
